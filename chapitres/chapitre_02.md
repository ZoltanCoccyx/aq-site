...
<!-- BLOC:exemple id="exemple-1" titre="Question de recherche" -->
...
<!-- BLOC:definition id="definition-1" titre="Hypothèse" -->
...
<!-- BLOC:definition id="definition-2" titre="Opérationnalisation" -->
**Définition — Opérationnalisation**
...
Le plus souvent, on cherche en science humaine à discuter des réalités humaines plus compliquées : par exemple, l'effet de la beauté sur la réussite professionnelle[^1], la relation entre salaire et confiance pour le futur, les retombées économiques du REM...
...
<!-- BLOC:exemple id="exemple-7" titre="Indice de Développement Humain (IDH)" -->
**Exemple — Indice de Développement Humain (IDH)**
...
<!-- BLOC:methode id="methode-1" titre="Opérationnaliser un concept" -->
**Méthode — Opérationnaliser un concept**
...
Dans ce dernier cas, il faut créer des outils de collecte adaptés aux variables définies lors de l'opérationnalisation ainsi qu'au type d'unités statistiques auxquelles on s'intéresse[^4].
...
<!-- BLOC:definition id="definition-3" titre="Échantillonnage" -->
...
<!-- BLOC:exemple id="exemple-14" titre="Comparaison des méthodes" -->
...
**Figure 3 — Processus de recherche quantitative**
<!-- /BLOC:figure -->
